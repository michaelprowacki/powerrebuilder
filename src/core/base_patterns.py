...
class ValidationMixin:
    ...
    def validate_input(
        self, data: Any, rules: list[Callable[[Any], bool]] | None = None
    ) -> bool:
    ...
    def validate_output(self, data: Any, expected_type: type | None = None) -> bool:
...
class ConfigurableMixin:
    ...
    def __init__(self, *args, config: ConfigDict | BaseConfig | None = None, **kwargs):
        super().__init__(*args, **kwargs)
        self._config = self._load_config(config)

    def _load_config(self, config: ConfigDict | BaseConfig | None) -> BaseConfig:
...
class ProgressReportingMixin:
    ...
    def __init__(
        self, *args, progress_reporter: IProgressReporter | None = None, **kwargs
    ):
        super().__init__(*args, **kwargs)
...
class BaseCoordinator(
    ...
    def __init__(
        ...
        config: ConfigDict | BaseConfig | None = None,
