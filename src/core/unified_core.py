...
class UniversalBinaryReader:
    ...
    def read_string(
        self, size: int | None = None, null_terminated: bool = False
    ) -> str:
    ...
    def read_unicode_string(self, size: int | None = None) -> str:
...
class UniversalBinaryWriter:
    ...
    def write_string(
        self, text: str, size: int | None = None, null_terminate: bool = True
    ) -> None:
...
class UniversalFileOps:
    ...
    @staticmethod
    def read_file(path: Path, binary: bool = True) -> bytes | str:
        """Read file content."""
    ...
    @staticmethod
    def write_file(path: Path, content: bytes | str, create_dirs: bool = True) -> None:
        """Write file content."""
        if create_dirs:
...
class StageConfig:
    ...
    custom_processor: Callable | None = None
...
class UniversalCoordinator:
    ...
    def discover_files(self, patterns: list[str] | None = None) -> list[Path]:
