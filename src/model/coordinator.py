...
class ModelCoordinator(CoordinationBase):
    ...
    def __init__(
        self, input_path: Path, output_path: Path, config: dict[str, Any] | None = None
    ):
        ...
        try:
            ...
            for ast_file in ast_files:
                try:
                    ...
                    results["errors"].append({"file": str(ast_file), "error": str(e)})
            ...
            logger.info(
                f"Model stage completed: {results['models_created']} models created"
            )
            return results
    ...
    def _process_single_file(self, ast_file: Path) -> dict[str, Any] | None:
...
def create_model_coordinator(
    input_path: str, output_path: str, config: dict[str, Any] | None = None
) -> ModelCoordinator:
